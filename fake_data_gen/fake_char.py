...
with open('matches.csv', 'w', newline='') as file:
    ...
    writer.writerow(["player1", "player2", "status", "player1_char", "player2_char"])
    for _ in range(2500000):
        ...
        player1_char = fake.random_int(min=38, max=74)
        player2_char = fake.random_int(min=38, max=74)
        writer.writerow([player, opponent, status, player1_char, player2_char])
